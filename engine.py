...
class AgentOrchestrator:
    ...
    def sync_memory(self, user_id: str, current_query: str, current_style: str) -> UserProfile:
        ...
        updater_prompt = ChatPromptTemplate.from_messages([
            ("system", "Analyze the user's request. Return an updated JSON profile. Append new keywords to core_interests (max 8). Increment category_weights based on context."),
